        ...
        <div className="bg-white text-black rounded-lg w-full">
          <div className="flex justify-center md:justify-between flex-wrap gap-8 px-14 py-20 mb-6 border bg-sky-50 border-sky-400 rounded-xl">
            ...
            <div className="flex flex-col justify-center text-end text-sm max-md:mx-auto max-md:text-center">
              <button className="bg-blue-600 p-2.5 text-white px-10 rounded">
                Apply Now
              </button>
          ...
          <div className="flex flex-col lg:flex-row justify-between items-start">
            <div className="w-full lg:w-2/3">
              ...
              ></div>
              <button className="bg-blue-600 p-2.5 text-white px-10 rounded mt-10">
                Apply Now
              </button>
            </div>
            {/* Right section more JObs */}
            <div className="w-full lg:w-1/3 mt-8 lg:mt-0 lg:ml-8 space-y-5 ">
              <h2 className="text-2xl">More Job from {jobData.companyId.name}</h2>
              {jobs
                .filter(
                  (job) =>
                    job._id !== jobData._id &&
